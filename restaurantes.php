<?php
    ...
    $sql = "SELECT * FROM tbl_restaurantes WHERE iddepartamento=".$id;
...
<body>
     ...
     <h2 style="font-family: 'Trade Winds', cursive;">Restaurante</h2>
     ...
     <!--------------Lista de hoteles------------------>
                ...
                <?php
                      ...
                      echo '
                           ...
                           <h4 style="color:#DF73FF;">Direccion:</h4>
                           <p>'.utf8_encode($fila["direccion"]).'</p>
                           <h4 style="color:#DF73FF;">Descripcion:</h4>
